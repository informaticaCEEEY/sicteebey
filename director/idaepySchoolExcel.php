...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			...
			echo('</form>');
			?>
			<div class='text-center'><h2 class='form-signin-heading'>Reporte por Escuela</h2></div><hr />
			<form role="form" name="entry" id="entry" class="form-signin" action="../reports/idaepyReportExcel.php" method="post" accept-charset="UTF-8">
				<?php
