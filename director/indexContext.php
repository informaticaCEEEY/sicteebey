...
<body>
  ...
  <div class="container">
    <div class="col-xs-12 text-center">
      ...
      <form role="form" name="contextZone15" id="contextZone15" action="../reports/factorZone.php" method="post" accept-charset="UTF-8">
        <input type="hidden" id="year" name="year" value="2015"/>
        <input type="hidden" id="type" name="type" value="1"/>
        <input type="hidden" id="schoolLevel" name="schoolLevel" value="<?php echo($user->getSchoolObject()->getLevel()) ?>"/>
      </form>
      <form role="form" name="contextZone17" id="contextZone17" action="../reports/factorZone.php" method="post" accept-charset="UTF-8">
        <input type="hidden" id="year" name="year" value="2017"/>
        <input type="hidden" id="type" name="type" value="1"/>
        <input type="hidden" id="schoolLevel" name="schoolLevel" value="<?php echo($user->getSchoolObject()->getLevel()) ?>"/>
      </form>

      <form role="form" name="contextCCT15" id="contextCCT15" action="../reports/factorSchoolInfo.php" method="post" accept-charset="UTF-8">
        <input type="hidden" id="cct" name="cct" value="<?php echo($user->getSchoolObject()->getCct()) ?>"/>
        <input type="hidden" id="year" name="year" value="2015"/>
        <input type="hidden" id="level" name="level" value="2"/>
        <input type="hidden" id="type" name="type" value="1"/>
      </form>
      <form role="form" name="contextCCT17" id="contextCCT17" action="../reports/factorSchoolInfo.php" method="post" accept-charset="UTF-8">
        <input type="hidden" id="cct" name="cct" value="<?php echo($user->getSchoolObject()->getCct()) ?>"/>
        <input type="hidden" id="year" name="year" value="2017"/>
        <input type="hidden" id="level" name="level" value="2"/>
        <input type="hidden" id="type" name="type" value="1"/>
      </form>
      <form role="form" name="contextDocentesCCT17" id="contextDocentesCCT17" action="../reports/factorSchoolInfo.php" method="post" accept-charset="UTF-8">
        <input type="hidden" id="cct" name="cct" value="<?php echo($user->getSchoolObject()->getCct()) ?>"/>
        <input type="hidden" id="year" name="year" value="2017"/>
        <input type="hidden" id="level" name="level" value="2"/>
        <input type="hidden" id="type" name="type" value="2"/>
      ...
      <div class="text-justify" id="instructions">
        ...
        if($year == 2015){
          ...
          <ul class="custom-bullet">
            ...
            <ul>
              <li>
                Cuestionarios de Contexto de Docentes y Directores 2015
              </li>
              <ul>
                <li>
