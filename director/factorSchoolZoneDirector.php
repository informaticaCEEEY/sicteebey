...
$schoolZone = $schoolZoneController->getEntityAction($_POST['schoolZone']);
...
<html lang="es">
	...
	<body>
		...
		<div class="container-fluid">
                ...
                include_once('../functions/functionChartZoneDirector.php');
				
				?>
			<form role="form" name="schoolZone" id="schoolZone" action="schoolZoneIndex.php" method="post" accept-charset="UTF-8">
                <input type="hidden" id="schoolZone" name="schoolZone" value="<?php echo($schoolZone -> getId()); ?>"/>              
            </form>
            <button class="buttonBack" type="button" onclick="document.forms.schoolZone.submit()"><span>Regresar</span></button>
            <?php 
			...
			<div class="col-xs-12 col-md-12">
                ...
                <div><h4 class='form-signin-heading col-md-3'>Modalidad: <?php echo($schoolZone -> getSchoolModeObject() -> getName()); ?> </h4></div>
                <div><h4 class='form-signin-heading col-md-3'>Regi&oacute;n: <?php echo($schoolZone -> getSchoolRegionObject() -> getName()); ?> </h4></div>
                <div><h4 class='form-signin-heading col-md-3'>Zona Escolar: <?php echo(str_pad($schoolZone->getZone(),  3, "0", STR_PAD_LEFT)); ?> </h4></div>
			</div>
			<div class="col-xs-12 col-md-12">
				<hr />	
			</div>					
			...
			<form role="form" name="entry" id="entry" class="form-signin" action="dispatchers/factorDispatcher.php" method="post" accept-charset="UTF-8">
				...
				$form -> contextFactorZoneDirectorForm($schoolZone->getId(), $indexList->getId());
				...
				<div class="text-center">
					...
					<button type="button" class="btn btn-lg btn-danger" onclick="document.forms.schoolZone.submit()">Cancelar</button>
				</div>
			</form>
		</div>
		<!-- /container -->
