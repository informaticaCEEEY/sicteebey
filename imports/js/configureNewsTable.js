add=new Array('add', 'addButton', 'Nueva noticia');
edit=new Array('edit', 'editButton', 'Editar noticia');
view=new Array('view', 'viewButton', 'Vista previa');
deleted=new Array('', 'deleteButton', 'Eliminar');
buttons=new Array(add,edit,view);
var oTable;
var aData;
var gaiSelected =  [];
var pop;
...
//menuBar+= '<button id=\"'+buttons[3][1]+'\" name=\"\" type=\"button\" class=\"btn btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span> '+buttons[3][2]+''
//    + '</button>';
...
$(document).ready(function() {
    oTable = $('#entity').dataTable({
        ...
        "aoColumns" : [{"bVisible" : 0}, null, null, null, null],
        "oLanguage" : {
