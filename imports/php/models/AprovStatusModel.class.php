<?php
class AprovStatusModel{

	private $dao;

	function __construct(){

		$this->dao=new AprovStatusDAO();
	}
	...
	public function addAprovStatus(AprovStatus $value){

		return $this->dao->add($value);
	}

	public function updateAprovStatus(AprovStatus $value){

		return $this->dao->update($value);
	}

	public function deleteAprovStatus(AprovStatus $value){
