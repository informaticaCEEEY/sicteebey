...
class FamilyContextModel{
	...
	public function addFamilyContext(FamilyContext $value){

		return $this->dao->add($value);
	}

	public function updateFamilyContext(FamilyContext $value){

		return $this->dao->update($value);
	}

	public function deleteFamilyContext(FamilyContext $value){
