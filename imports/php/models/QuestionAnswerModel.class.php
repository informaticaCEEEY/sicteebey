...
class QuestionAnswerModel{
	...
	function __construct(){
		...
		$this->dao=new QuestionAnswerDAO();
	}
	...
	public function addQuestionAnswer(QuestionAnswer $value){

		return $this->dao->add($value);
	}

	public function updateQuestionAnswer(QuestionAnswer $value){

		return $this->dao->update($value);
	}

	public function deleteQuestionAnswer(QuestionAnswer $value){
