...
class FoodConsumptionModel{
	...
	function __construct(){
		...
		$this->dao=new FoodConsumptionDAO();
	}
	...
	public function addFoodConsumption(FoodConsumption $value){

		return $this->dao->add($value);
	}

	public function updateFoodConsumption(FoodConsumption $value){

		return $this->dao->update($value);
	}

	public function deleteFoodConsumption(FoodConsumption $value){
