<?php
class FactorGradeModel{

	private $dao;

	function __construct(){

		$this->dao=new FactorGradeDAO();
	}
	...
	public function addFactorGrade(FactorGrade $value){

		return $this->dao->add($value);
	}

	public function updateFactorGrade(FactorGrade $value){

		return $this->dao->update($value);
	}

	public function deleteFactorGrade(FactorGrade $value){
