<?php
class AprovGenderModel{

	private $dao;

	function __construct(){

		$this->dao=new AprovGenderDAO();
	}
	...
	public function addAprovGender(AprovGender $value){

		return $this->dao->add($value);
	}

	public function updateAprovGender(AprovGender $value){

		return $this->dao->update($value);
	}

	public function deleteAprovGender(AprovGender $value){
