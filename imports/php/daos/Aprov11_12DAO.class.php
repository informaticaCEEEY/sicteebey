<?php
class Aprov11_12DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov11_12', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov11_12(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov11_12 $entity=null){
	...
	public function update(Aprov11_12 $entity=null){
	...
	public function delete(Aprov11_12 $entity=null){
