<?php
class AprovModeDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov_mode', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new AprovMode(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(AprovMode $entity=null){
	...
	public function update(AprovMode $entity=null){
	...
	public function delete(AprovMode $entity=null){
