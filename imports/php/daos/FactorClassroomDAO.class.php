<?php
class FactorClassroomDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('factor_classroom', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new FactorClassroom(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(FactorClassroom $entity=null){
	...
	public function update(FactorClassroom $entity=null){
	...
	public function delete(FactorClassroom $entity=null){
