<?php
class AprovModeStatusDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov_mode_status', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new AprovModeStatus(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(AprovModeStatus $entity=null){
	...
	public function update(AprovModeStatus $entity=null){
	...
	public function delete(AprovModeStatus $entity=null){
