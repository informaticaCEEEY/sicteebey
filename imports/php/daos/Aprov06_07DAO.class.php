<?php
class Aprov06_07DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov06_07', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov06_07(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov06_07 $entity=null){
	...
	public function update(Aprov06_07 $entity=null){
	...
	public function delete(Aprov06_07 $entity=null){
