<?php
class Aprov12_13DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov12_13', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov12_13(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov12_13 $entity=null){
	...
	public function update(Aprov12_13 $entity=null){
	...
	public function delete(Aprov12_13 $entity=null){
