<?php
class Aprov05_06DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov05_06', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov05_06(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov05_06 $entity=null){
	...
	public function update(Aprov05_06 $entity=null){
	...
	public function delete(Aprov05_06 $entity=null){
