<?php
class IdaepyPercentageModeDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('idaepy_percentage_mode', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new IdaepyPercentageMode(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(IdaepyPercentageMode $entity=null){
	...
	public function update(IdaepyPercentageMode $entity=null){
	...
	public function delete(IdaepyPercentageMode $entity=null){
