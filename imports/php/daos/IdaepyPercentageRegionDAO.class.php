<?php
class IdaepyPercentageRegionDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('idaepy_percentage_region', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new IdaepyPercentageRegion(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(IdaepyPercentageRegion $entity=null){
	...
	public function update(IdaepyPercentageRegion $entity=null){
	...
	public function delete(IdaepyPercentageRegion $entity=null){
