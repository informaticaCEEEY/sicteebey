<?php
class Aprov08_09DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov08_09', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov08_09(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov08_09 $entity=null){
	...
	public function update(Aprov08_09 $entity=null){
	...
	public function delete(Aprov08_09 $entity=null){
