<?php
class IdaepyDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('idaepy', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Idaepy(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Idaepy $entity=null){
	...
	public function update(Idaepy $entity=null){
	...
	public function delete(Idaepy $entity=null){
