<?php
class Aprov17_18DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov17_18', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov17_18(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov17_18 $entity=null){
	...
	public function update(Aprov17_18 $entity=null){
	...
	public function delete(Aprov17_18 $entity=null){
