<?php
class Aprov10_11DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov10_11', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov10_11(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov10_11 $entity=null){
	...
	public function update(Aprov10_11 $entity=null){
	...
	public function delete(Aprov10_11 $entity=null){
