<?php
class IdaepyPercentageZoneDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('idaepy_percentage_zone', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new IdaepyPercentageZone(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(IdaepyPercentageZone $entity=null){
	...
	public function update(IdaepyPercentageZone $entity=null){
	...
	public function delete(IdaepyPercentageZone $entity=null){
