<?php
class Aprov18_19DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov18_19', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov18_19(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov18_19 $entity=null){
	...
	public function update(Aprov18_19 $entity=null){
	...
	public function delete(Aprov18_19 $entity=null){
