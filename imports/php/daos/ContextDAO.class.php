<?php
class ContextDAO extends AbstractDAO implements ManipulateObjects {
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Context(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Context $entity=null){
	...
	public function update(Context $entity=null){
	...
	public function delete(Context $entity=null){
