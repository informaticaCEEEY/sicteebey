<?php
class FactorGradeDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('factor_grade', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new FactorGrade(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(FactorGrade $entity=null){
	...
	public function update(FactorGrade $entity=null){
	...
	public function delete(FactorGrade $entity=null){
