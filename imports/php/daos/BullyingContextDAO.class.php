<?php
class BullyingContextDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('bullying_context', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new BullyingContext(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(BullyingContext $entity=null){
	...
	public function update(BullyingContext $entity=null){
	...
	public function delete(BullyingContext $entity=null){
