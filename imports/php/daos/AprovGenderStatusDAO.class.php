<?php
class AprovGenderStatusDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov_gender_status', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new AprovGenderStatus(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(AprovGenderStatus $entity=null){
	...
	public function update(AprovGenderStatus $entity=null){
	...
	public function delete(AprovGenderStatus $entity=null){
