<?php
class Aprov14_15DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov14_15', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov14_15(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov14_15 $entity=null){
	...
	public function update(Aprov14_15 $entity=null){
	...
	public function delete(Aprov14_15 $entity=null){
