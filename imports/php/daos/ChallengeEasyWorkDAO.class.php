<?php
class ChallengeEasyWorkDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('challenge_easy_work', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new ChallengeEasyWork(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(ChallengeEasyWork $entity=null){
	...
	public function update(ChallengeEasyWork $entity=null){
	...
	public function delete(ChallengeEasyWork $entity=null){
