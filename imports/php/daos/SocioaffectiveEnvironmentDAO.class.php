<?php
class SocioaffectiveEnvironmentDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('socioaffective_environment', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new SocioaffectiveEnvironment(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(SocioaffectiveEnvironment $entity=null){
	...
	public function update(SocioaffectiveEnvironment $entity=null){
	...
	public function delete(SocioaffectiveEnvironment $entity=null){
