<?php
class Aprov17DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov17', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov17(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov17 $entity=null){
	...
	public function update(Aprov17 $entity=null){
	...
	public function delete(Aprov17 $entity=null){
