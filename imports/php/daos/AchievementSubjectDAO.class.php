<?php
class AchievementSubjectDAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('achievement_subject', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new AchievementSubject(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(AchievementSubject $entity=null){
	...
	public function update(AchievementSubject $entity=null){
	...
	public function delete(AchievementSubject $entity=null){
