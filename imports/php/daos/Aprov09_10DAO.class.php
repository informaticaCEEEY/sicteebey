<?php
class Aprov09_10DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov09_10', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov09_10(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov09_10 $entity=null){
	...
	public function update(Aprov09_10 $entity=null){
	...
	public function delete(Aprov09_10 $entity=null){
