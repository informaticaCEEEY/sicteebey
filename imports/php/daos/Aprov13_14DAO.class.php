<?php
class Aprov13_14DAO extends AbstractDAO implements ManipulateObjects {

	function __construct($id=''){

		parent::__construct('aprov13_14', 'id');
	}
	...
	public function createObject($data=null){
		...
		if($data!=null){
			...
			extract($data);
			$object = new Aprov13_14(gosSanitizer::sanitizeForHTMLContent($id));
	...
	public function add(Aprov13_14 $entity=null){
	...
	public function update(Aprov13_14 $entity=null){
	...
	public function delete(Aprov13_14 $entity=null){
