...
class Procrastination{
	...
	public function setP04($P04){

		$this->P04=Validate::validateInteger($P04);
	}
	...
	public function setP05($P05){

		$this->P05=Validate::validateInteger($P05);
	}
	...
	public function setP06($P06){

		$this->P06=Validate::validateInteger($P06);
	}
	...
	public function dataVector(){
		...
		array_push($vector, $this->getP04());
		array_push($vector, $this->getP05());
		array_push($vector, $this->getP06());
