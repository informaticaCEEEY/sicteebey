...
$table1 .= '
<h2 class="text-center">Trayectorias Escolares por Región</h2><br />
<table class="table2">
	<tr>
		<td width="200" class="tableInfo"><b>Nivel:</b> ' . $schoolLevelObject->getName() . '</td>
		<td width="200" class="tableInfo"><b>Regi&oacute;n:</b> ' . $schoolRegionObject->getName() . '</td>
	</tr>
</table>';
