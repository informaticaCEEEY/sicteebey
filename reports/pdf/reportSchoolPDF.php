...
$table1 .= '
<h2 class="text-center">Trayectorias Escolares por Escuela</h2><br />
<table class="table2" width="700">
	<tr>
		<td width="120" class="tableInfo"><b>CCT:</b> ' . $school->getCct() . '</td>
		<td width="550" colspan="4" class="tableInfo"><b>Escuela:</b> ' . $school->getName() . '</td>
	</tr>
	<tr>
		<td width="140" class="tableInfo"><b>Nivel:</b> ' . $school->getSchoolLevelObject()->getName() . '</td>
		<td width="140" class="tableInfo"><b>Modalidad:</b> ' . $school->getSchoolModeObject()->getName() . '</td>
		<td width="160" class="tableInfo"><b>Marginación:</b> ' . $school->getSchoolMarginalizationObject()->getName() . '</td>
		<td width="140" class="tableInfo"><b>Regi&oacute;n:</b> ' . $school->getSchoolRegionObject()->getName() . '</td>
		<td width="30" class="tableInfo"><b>Zona:</b> ' . str_pad($schoolZone,  3, "0", STR_PAD_LEFT) . '</td>
	</tr>
</table>';
...
while($ciclo < $numCiclo){
  ...
  /* Variables grade almacenan el numero de alumnos inscritos  por grado */
	...
	if($ciclo < 6){
		...
		$whereFields = array('grade' => 1, 'reprobate' => 0, 'cct' => $school->getId(), 'cct2' => $school->getId());
