 ...
 ?>
		...
		<div class="container-fluid">
		    <?php if($factor == 17 || $factor == 30){ ?>
    			<form name="schoolIndex" id="schoolIndex" action="../<?php echo $user->getAbbreviation() ?>/schoolIndexChart.php" method="post" accept-charset="UTF-8">
    			    <input type="hidden" id="cct" name="cct" value="<?php echo($school -> getCct()); ?>"/>
    			</form>
			<?php }else{ ?>
			    <form name="schoolIndex" id="schoolIndex" action="../<?php echo $user->getAbbreviation() ?>/factorSchoolDirector.php" method="post" accept-charset="UTF-8">
                    <input type="hidden" id="school" name="school" value="<?php echo($school -> getId()); ?>"/>
			...
			include_once('../functions/functionIndexSchool.php');
