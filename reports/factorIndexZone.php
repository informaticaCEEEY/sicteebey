 ...
 ?>
		...
		<div class="container-fluid">
		    <?php if($factor == 17 || $factor == 30){ ?>
    			<form name="schoolIndex" id="schoolIndex" action="../<?php echo $user->getAbbreviation() ?>/schoolZoneIndex.php" method="post" accept-charset="UTF-8">
    			    <input type="hidden" id="schoolZone" name="schoolZone" value="<?php echo($schoolZone); ?>"/>
    			</form>
			<?php }else{ ?>
			    <form name="schoolIndex" id="schoolIndex" action="../<?php echo $user->getAbbreviation() ?>/factorSchoolZoneDirector.php" method="post" accept-charset="UTF-8">
                    <input type="hidden" id="schoolZone" name="schoolZone" value="<?php echo($schoolZone); ?>"/>
