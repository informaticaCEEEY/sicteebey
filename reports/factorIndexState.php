    ...
    ?>
		...
		<div class="container-fluid">
		    <?php if($factor == 17 || $factor == 30){ ?>
		            <form name="stateIndex" id="stateIndex" action="../<?php echo $user->getAbbreviation() ?>/contextDirector.php" method="post" accept-charset="UTF-8">
		            </form>
            <?php }else{ ?>
                <form name="stateIndex" id="stateIndex" action="../<?php echo $user->getAbbreviation() ?>/factorStateDirector.php" method="post" accept-charset="UTF-8">
