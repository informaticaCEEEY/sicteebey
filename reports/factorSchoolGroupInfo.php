...
if (!isset($_POST['factor']) || !isset($_POST['idSchool']) || !isset($_POST['groupSchool'])) {
  ...
  $schoolGroup = $idaepyController->getEntityAction($groupSchool);
...
<html lang="es">
  ...
  ?>
    <div class="container-fluid">
      <form role="form" name="backPage" id="backPage" action="factorSchoolGroup.php" method="post" accept-charset="UTF-8">
  ...
  <?php
    include_once('../functions/chartSchoolGroup.php');
  ?>
      ...
      <div class="row">
        ...
        foreach($questionsList as $questionObject){
		    echo '<div id="chart'.$countQuestion.'" class="col-xs-12 col-md-6 factorGraph" align="center"></div>';
