...
if($user->getType() == 4){
	$schoolMode = $user->getSchoolObject()->getMode();
  $schoolZone = $user->getSchoolObject()->getZone();
}elseif($user->getType() == 5){
  ...
  $schoolMode = $supervisorSchoolRegion[0]->getSchoolMode();
  $schoolZone = $supervisorSchoolRegion[0]->getSchoolZone();
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form name="schoolFactor" id="schoolFactor" action="contextZone.php" method="post" accept-charset="UTF-8">
      ...
      <input name="type" id="type" type="hidden" value=<?php echo $_POST['type'] ?> />
    </form>
    ...
    <div class="col-xs-12 col-md-12">
      ...
      <div><h4 class='form-signin-heading col-md-3'>Regi&oacute;n: Pendiente </h4></div>
    ...
    <form role="form" name="entry" id="entry" class="form-signin" action="dispatchers/factorDispatcher.php" method="post" accept-charset="UTF-8">
      <?php
      $form -> contextFactorZoneForm($schoolZone, $_POST['year'], $_POST['type'], $schoolLevel, $schoolMode);
