...
if(!isset($_POST['year']) || !isset($_POST['groupby']) || !isset($_POST['cct']) || !isset($_POST['type'])){
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form name="schoolFactor" id="schoolFactor" action="contextAdm.php" method="post" accept-charset="UTF-8">
      <input type="hidden" id="year" name="year" value="<?php echo($yearApplication); ?>"/>
    ...
    <form role="form" name="entry" id="entry" class="form-signin" action="factorSchoolGroup.php" method="post" accept-charset="UTF-8">
      ...
      $form = new FactorForm();
      $form -> contextFactorGroupForm($school->getCct(), $yearApplication, $groupby, $_POST['type']);
      ?>
      <br />
