...
$whereA = "e.year = $year";
$orderA = "e.order_number asc";
$achievementList = $achievementIdaepyController->displayByAction($whereA, '', '', $orderA);
$achievementTotal = count($achievementList);
...
//Número de Alumnos Evaluados y Programados por grado
...
//Si el grado no fue evaluado  programado se le asigna cero
...
$pdf = new PDF_MC_Table('L','mm',array(835,680));
$pdf->AddFont('OpenSans','','OpenSans-Regular.php');
$pdf->AddFont('OpenSans','B','OpenSans-Bold.php');
$pdf->AddPage();
$pdf->Image('../content/images/idaepy/fondo2017.png',0,0,835,680,'');
...
$sizeNumGroup = 0;
if($achievementTotal == 3){
  $sizeAchievement = 50;
}else{
  $sizeAchievement = 40;
}
$sizeAchievementTitle = $sizeAchievement * $achievementTotal;
...
/*$pdf->SetWidths(array(60, 60, 25, 65));
$pdf->setAligns(array('C', 'C', 'C', 'C'));
$pdf->setFonts(array(array('OpenSans','B', '16'), array('OpenSans','B', '16'),
        array('OpenSans','B', '16'), array('OpenSans','B', '16')));
$pdf->RowX(array('Asignatura', 'Reactivos Evaluados', 'Grupo', 'Porcentaje de aciertos'));*/
...
$pdf->Cell($sizeAchievementTitle,$heightOneGroup, "Porcentaje de alumnos por nivel de logro",1,0,'C',1);
$actualPosition = $actualPosition + $heightOneGroup;
$pdf->SetXY(240, $actualPosition);
foreach($achievementList as $achievement){
  $achievementTitle = $achievement->getAchievementObject()->getName();
  $pdf->SetFillColor($achievement->getCodeR(), $achievement->getCodeG(), $achievement->getCodeB());
  $pdf->Cell($sizeAchievement,$heightOneGroup, utf8_decode($achievementTitle),1,0,'C',1);
}
...
if(isset($totalGradeProg[3]) && $totalGradeProg[3] != 0){
    ...
    foreach($idaepyAchievementTotalGroup[3] as $idaepyGroup){
        ...
        foreach($achievementList as $achievementSubjectLevel){
          ...
          $keyLevel = $achievementSubjectLevel->getAchievement();
          ...
          $pdf->Cell($sizeAchievement, $heightOneGroup, number_format($percentageMathAchievement[$keyLevel], 1),$border,0,'C');
          $heightPositionGroup3 = $heightPositionGroup3 + $heightGroup;
          $pdf->SetXY($sizeNumAchievement, $heightPositionGroup3);
          $pdf->Cell($sizeAchievement, $heightOneGroup, number_format($percentageSpanishAchievement[$keyLevel], 1),$border,0,'C');
          $heightPositionGroup3 = $heightPositionGroup3 + $heightGroup;
          $pdf->SetXY($sizeNumAchievement, $heightPositionGroup3);
          $pdf->Cell($sizeAchievement, $heightOneGroup, number_format($percentageScienceAchievement[$keyLevel], 1),$border,0,'C');
          $sizeNumAchievement = $sizeNumAchievement + $sizeAchievement;
        }
...
$pdf->Ln(25);
//$pdf->SetWidths(array(110, 35, 80, 45, 100, 110, 35, 80, 45, 80));
$pdf->SetWidths(array(120, 60, 100, 48, 85, 120, 60, 100, 48, 100));
$pdf->setFonts(array(array('OpenSans','B',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles), array('OpenSans','B',$sizeLetterTitles),
        array('OpenSans','',$sizeLetterTitles), array('OpenSans','B',$sizeLetterTitles), array('OpenSans','B',$sizeLetterTitles),
        array('OpenSans','',$sizeLetterTitles), array('OpenSans','B',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
        array('OpenSans','B',$sizeLetterTitles)));
$pdf->Row(array('Quinto Grado', 'Programados:', $totalGradeProg['5'], 'Evaluados:', $totalGradeEva['5'], 'Sexto Grado',
        'Programados:', $totalGradeProg['6'], 'Evaluados:', $totalGradeEva['6']));
...
if(isset($totalGradeProg[5]) && $totalGradeProg[5] != 0){
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont('OpenSans', '', '20');
    $pdf->Cell(60,$heightGroup,'24','B',0,'C');
    // Español
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont('OpenSans', '', '20');
    $pdf->Cell(60,$heightGroup,'22','B',0,'C');
    // Ciencias Naturales
    $heightPositionGroup5 = $heightPositionGroup5 + $heightGroup;
    $pdf->SetXY(30, $heightPositionGroup5);
    $pdf->SetFillColor(104, 59, 17);
...
if(isset($totalGradeProg[6]) && $totalGradeProg[6] != 0){
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont('OpenSans', '', '20');
    $pdf->Cell(60,$heightGroup,'26','B',0,'C');
    // Español
    $heightPositionGroup = $heightPositionGroup + $heightGroup;
    $pdf->SetXY(440, $heightPositionGroup);
    $pdf->SetFillColor(35, 187, 234);
...
$pdf->AddPage();
$pdf->Image('../content/images/idaepy/fondo2017.png',0,0,835,680,'');
$pdf -> Image('../img/Logo_segey.png', 30, 10, 80);
$pdf->Ln(40);
$levelAchievement = $pdf->GetY();
$pdf->SetFont('OpenSans', 'B', '28');
$pdf->SetXY(10, $levelAchievement+110);
$pdf->Cell(20,15,utf8_decode('3°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+230);
$pdf->Cell(20,15,utf8_decode('4°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+360);
$pdf->Cell(20,15,utf8_decode('5°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+520);
...
$pdf->SetTextColor(255, 255, 255);
$pdf->SetFont('OpenSans', 'B', '28');
$pdf->Cell(780,18,utf8_decode('Niveles de Logro: MATEMÁTICAS'),'1',0,'C',1);
$pdf->Ln();
$pdf->SetX(30);
$pdf->setFillColor(176, 126, 75);
$pdf->Cell(50,24, 'Inicial',1,0,'C',1);
$pdf->setFonts(array(array('OpenSans','','24')));
$pdf->SetWidths(array(730));
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFill(array(0));
$pdf->RowX(array(utf8_decode($achievementLevels[1][6][1])));

$pdf->SetFont('OpenSans', 'B', '28');
$pdf->SetTextColor(255, 255, 255);
$pdf->SetFillColor(178, 18, 112);
$pdf->Cell(240,20, 'Basico',1,0,'C',1);
$pdf->SetFillColor(247, 124, 22);
$pdf->Cell(300,20, 'Medio',1,0,'C',1);
$pdf->SetFillColor(28, 153, 83);
$pdf->Cell(240,20, 'Avanzado','1',0,'C',1);
$pdf->Ln();
$pdf->SetTextColor(0, 0, 0);
...
$pdf->Row2(array(utf8_decode($achievementLevels[1][3][2]), utf8_decode($achievementLevels[1][3][3]),
    utf8_decode($achievementLevels[1][3][4])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[1][4][2]), utf8_decode($achievementLevels[1][4][3]),
    utf8_decode($achievementLevels[1][4][4])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[1][5][2]), utf8_decode($achievementLevels[1][5][3]),
    utf8_decode($achievementLevels[1][5][4])));


$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[1][6][2]), utf8_decode($achievementLevels[1][6][3]),
    utf8_decode($achievementLevels[1][6][4])));
...
$pdf->SetXY(10, $levelAchievement+220);
$pdf->Cell(20,15,utf8_decode('4°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+345);
$pdf->Cell(20,15,utf8_decode('5°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+465);
$pdf->Cell(20,15,utf8_decode('6°'),'',0,'C');
...
$pdf->SetTextColor(255, 255, 255);
$pdf->SetFont('OpenSans', 'B', '28');
$pdf->Cell(780,18,utf8_decode('Niveles de Logro: ESPAÑOL'),1,0,'C',1);
...
$pdf->SetTextColor(255, 255, 255);
$pdf->SetFillColor(178, 18, 112);
$pdf->Cell(220,20, 'Basico',1,0,'C',1);
$pdf->SetFillColor(247, 124, 22);
$pdf->Cell(280,20, 'Medio',1,0,'C',1);
$pdf->SetFillColor(28, 153, 83);
$pdf->Cell(280,20, 'Avanzado',1,0,'C',1);
$pdf->Ln();
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('OpenSans', '', '24');
//$pdf->Cell(78,10, utf8_decode($achievementLevels[1][3][1]),'R',2,'C',0);
...
$pdf->Row2(array(utf8_decode($achievementLevels[2][3][2]), utf8_decode($achievementLevels[2][3][3]),
    utf8_decode($achievementLevels[2][3][4])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[2][4][2]), utf8_decode($achievementLevels[2][4][3]),
    utf8_decode($achievementLevels[2][4][4])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[2][5][2]), utf8_decode($achievementLevels[2][5][3]),
    utf8_decode($achievementLevels[2][5][4])));


$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[2][6][2]), utf8_decode($achievementLevels[2][6][3]),
    utf8_decode($achievementLevels[2][6][4])));
...
$levelAchievement = $pdf->GetY();
$pdf->SetFont('OpenSans', 'B', '28');
$pdf->SetXY(10, $levelAchievement+105);
$pdf->Cell(20,15,utf8_decode('3°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+205);
$pdf->Cell(20,15,utf8_decode('4°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+315);
$pdf->Cell(20,15,utf8_decode('5°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+430);
$pdf->Cell(20,15,utf8_decode('6°'),'',0,'C');
...
$pdf->SetTextColor(255, 255, 255);
$pdf->SetFont('OpenSans', 'B', '28');
$pdf->Cell(780,15,'Niveles de Logro: CIENCIAS NATURALES',1,0,'C',1);
$pdf->Ln();
...
$pdf->SetFill(array(0));
$pdf->RowX(array(utf8_decode($achievementLevels[1][6][1])));
/*$pdf->SetFill(array(1, 0));
$pdf->setColorBackground(array(array(176, 126, 75)));
$pdf->SetTextColor(0, 0, 0);
$pdf->setSizeRows(12);
$pdf->SetAligns('C', 'L');
$pdf->setFonts(array(array('OpenSans','B','22'), array('OpenSans','','18')));
$pdf->SetWidths(array(50, 730));
$pdf->RowX(array('Inicial', utf8_decode($achievementLevels[1][6][111])));
*/
$pdf->SetFont('OpenSans', 'B', '28');
$pdf->SetTextColor(255, 255, 255);
$pdf->SetFillColor(178, 18, 112);
$pdf->Cell(250,20, 'Basico',1,0,'C',1);
$pdf->SetFillColor(247, 124, 22);
$pdf->Cell(250,20, 'Medio',1,0,'C',1);
$pdf->SetFillColor(28, 153, 83);
$pdf->Cell(280,20, 'Avanzado',1,0,'C',1);
$pdf->Ln();
$pdf->SetTextColor(0, 0, 0);
...
$pdf->Row2(array(utf8_decode($achievementLevels[3][3][2]), utf8_decode($achievementLevels[3][3][3]),
    utf8_decode($achievementLevels[3][3][4])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[3][4][2]), utf8_decode($achievementLevels[3][4][3]),
    utf8_decode($achievementLevels[3][4][4])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[3][5][2]), utf8_decode($achievementLevels[3][5][3]),
    utf8_decode($achievementLevels[3][5][4])));


$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[3][6][2]), utf8_decode($achievementLevels[3][6][3]),
    utf8_decode($achievementLevels[3][6][4])));
