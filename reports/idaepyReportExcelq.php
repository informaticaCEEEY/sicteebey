...
$img = '../img/segey80v.png'; // Provide path to your logo file
...
foreach($idaepyAchievementTotalGroup as $keyGrade => $idaepyGrade){
    ...
    foreach($idaepyGrade as $idaepyGroup){
        ...
        foreach($achievementArrayList as $keyLevel => $achievementSubjectLevel){
            ...
            $listPercentageAchievement['math'][$keyLevel][$idaepyGroup] = $percentageMathAchievement[$keyLevel] * $totalGroup;
            ...
            $listPercentageAchievement['spanish'][$keyLevel][$idaepyGroup] = $percentageSpanishAchievement[$keyLevel] * $totalGroup;
            ...
            $listPercentageAchievement['science'][$keyLevel][$idaepyGroup] = $percentageScienceAchievement[$keyLevel] * $totalGroup;
        ...
        $listPercentageByGrade[$keyGrade]['spanish'][$idaepyGroup] = $percentageSpanishHits * $totalGroup;
        $listPercentageByGrade[$keyGrade]['math'][$idaepyGroup] = $percentageMathHits * $totalGroup;
        $listPercentageByGrade[$keyGrade]['science'][$idaepyGroup] = $percentageScienceHits * $totalGroup;
        $count = $count + 1;
    }
    ...
    foreach($achievementList as $achievementSubjectLevel){
        $keyLevel = $achievementSubjectLevel->getId();
        $percentageGradeAchievement[2][$keyGrade][$keyLevel] = array_sum($listPercentageAchievement['spanish'][$keyLevel])/$totalGradeEva[$keyGrade];
        $percentageGradeAchievement[1][$keyGrade][$keyLevel] = array_sum($listPercentageAchievement['math'][$keyLevel])/$totalGradeEva[$keyGrade];
        $percentageGradeAchievement[3][$keyGrade][$keyLevel] = array_sum($listPercentageAchievement['science'][$keyLevel])/$totalGradeEva[$keyGrade];
