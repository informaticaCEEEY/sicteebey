...
if(!isset($_POST['year']) || !isset($_POST['type']) || !isset($_POST['level'])){
...
<html lang="es">
    ...
    <script>
	    function createCustomHTMLContent($category1, title1, frecuency1, percent) {
	...
	<body>
      ...
      include_once('../functions/functionChart.php');
			?>
			...
			<div class="row">
				<div class='text-center'>
					<h3 class='form-signin-heading'>Cuestionario de Contexto <?php echo($_POST['year']); ?></h3>
				</div>
        ...
        $form -> addForm($_POST['year'], $_POST['type'], $_POST['level']);
				?>
				<br />
				<div class="text-center">
