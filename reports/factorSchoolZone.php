...
// if (!$factorObject || !($schoolZoneObject)) {
//   echo('<form name="valid" id="valid" action="index.php" method="post"></form>');
//   echo('<script>document.forms.valid.submit()</script>');
// }
...
<html lang="es">
  ...
  ?>
    <div class="container-fluid">
      <form role="form" name="backPage" id="backPage" action="../<?php echo $user->getAbbreviation() ?>/factorZone.php" method="post" accept-charset="UTF-8">
        ...
        <input type="hidden" id="schoolLevel" name="schoolLevel" value="<?php echo($schoolLevel); ?>"/>
        <input type="hidden" id="schoolMode" name="schoolMode" value="<?php echo($schoolMode); ?>"/>
  ...
  <?php
    include_once('../functions/chartZone.php');
  ?>
