...
$schoolRegion = $school[0]->getSchoolRegionZoneObject()->getSchoolRegionObject()->getName();
$schoolZone = $school[0]->getSchoolRegionZoneObject()->getZone();
$schoolSector = $school[0]->getSchoolRegionZoneObject()->getSector();
...
$pdf->AddPage();
$pdf->Image('../content/images/idaepy/fondo2017.png',0,0,835,674,'');
$pdf->Image('../img/segey80v.png', 30, 10, 90);
$pdf->Ln(10);
...
$schoolRegion = utf8_decode($school[0]->getSchoolRegionZoneObject()->getSchoolRegionObject()->getAlternativeName());
$schoolZone = $school[0]->getSchoolRegionZoneObject()->getZone();
...
$pdf->Cell(160,$heightOneGroup, "Porcentaje de alumnos por nivel de logro",1,0,'C',1);
$actualPosition = $actualPosition + $heightOneGroup;
$pdf->SetXY(240, $actualPosition);
$pdf->SetFillColor(176, 126, 75);
$pdf->Cell(40,$heightOneGroup, 'Inicial',1,0,'C',1);
$pdf->SetFillColor(233, 57, 140);
$pdf->Cell(40,$heightOneGroup, utf8_decode('Básico'),1,0,'C',1);
$pdf->SetFillColor(216, 136, 25);
$pdf->Cell(40,$heightOneGroup, 'Medio',1,0,'C',1);
$pdf->SetFillColor(61, 152, 73);
...
if(isset($totalGradeProg[3]) && $totalGradeProg[3] != 0){
    ...
    foreach($idaepyAchievementTotalGroup[3] as $idaepyGroup){
        ...
        $totalMathAchievement =  $mathAchievementList[1] + $mathAchievementList[2] + $mathAchievementList[3] + $mathAchievementList[111];
        $totalScienceAchievement =  $scienceAchievementList[1] + $scienceAchievementList[2] + $scienceAchievementList[3] + $scienceAchievementList[111];
        $totalSpanishAchievement =  $spanishAchievementList[1] + $spanishAchievementList[2] + $spanishAchievementList[3] + $spanishAchievementList[111];
...
if(isset($totalGradeProg[6]) && $totalGradeProg[6] != 0){
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont('OpenSans', '', '20');
    $pdf->Cell(60,$heightGroup,'25','B',0,'C');
    // Español
    $heightPositionGroup = $heightPositionGroup + $heightGroup;
    $pdf->SetXY(440, $heightPositionGroup);
    $pdf->SetFillColor(35, 187, 234);
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont('OpenSans', '', '20');
    $pdf->Cell(60,$heightGroup,'23','B',0,'C');
    // Ciencias Naturales
    $heightPositionGroup = $heightPositionGroup + $heightGroup;
    $pdf->SetXY(440, $heightPositionGroup);
    $pdf->SetFillColor(104, 59, 17);
...
$pdf->SetXY(10, $levelAchievement+95);
$pdf->Cell(20,15,utf8_decode('3°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+190);
$pdf->Cell(20,15,utf8_decode('4°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+295);
$pdf->Cell(20,15,utf8_decode('5°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+420);
...
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFill(array(0));
$pdf->RowX(array(utf8_decode($achievementLevels[1][6][111])));
...
$pdf->Row2(array(utf8_decode($achievementLevels[1][3][1]), utf8_decode($achievementLevels[1][3][2]),
    utf8_decode($achievementLevels[1][3][3])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[1][4][1]), utf8_decode($achievementLevels[1][4][2]),
    utf8_decode($achievementLevels[1][4][3])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[1][5][1]), utf8_decode($achievementLevels[1][5][2]),
...
$pdf->Row2(array(utf8_decode($achievementLevels[1][6][1]), utf8_decode($achievementLevels[1][6][2]),
...
$pdf->SetXY(10, $levelAchievement+195);
$pdf->Cell(20,15,utf8_decode('4°'),'',0,'C');
...
$pdf->Row2(array(utf8_decode($achievementLevels[2][3][1]), utf8_decode($achievementLevels[2][3][2]),
    utf8_decode($achievementLevels[2][3][3])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[2][4][1]), utf8_decode($achievementLevels[2][4][2]),
    utf8_decode($achievementLevels[2][4][3])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[2][5][1]), utf8_decode($achievementLevels[2][5][2]),
...
$pdf->Row2(array(utf8_decode($achievementLevels[2][6][1]), utf8_decode($achievementLevels[2][6][2]),
...
$pdf->SetXY(10, $levelAchievement+225);
$pdf->Cell(20,15,utf8_decode('4°'),'',0,'C');

$pdf->SetXY(10, $levelAchievement+330);
$pdf->Cell(20,15,utf8_decode('5°'),'',0,'C');
...
$pdf->Row2(array(utf8_decode($achievementLevels[3][3][1]), utf8_decode($achievementLevels[3][3][2]),
    utf8_decode($achievementLevels[3][3][3])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[3][4][1]), utf8_decode($achievementLevels[3][4][2]),
    utf8_decode($achievementLevels[3][4][3])));

$pdf->setFonts(array(array('OpenSans','',$sizeLetterTitles), array('OpenSans','',$sizeLetterTitles),
    array('OpenSans','',$sizeLetterTitles)));

$pdf->Row2(array(utf8_decode($achievementLevels[3][5][1]), utf8_decode($achievementLevels[3][5][2]),
...
$pdf->Row2(array(utf8_decode($achievementLevels[3][6][1]), utf8_decode($achievementLevels[3][6][2]),
