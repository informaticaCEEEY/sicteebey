...
<html lang="es">
	...
	<body>
		...
		<div class="container">
				<?php $form = new ContextApplicationForm();
				...
				echo('</form>');
				?>
				<form role="form" name="entry" id="entry" class="form-signin" action="factorSchoolData.php" method="post" accept-charset="UTF-8">
					<?php
          ...
          if($user->getType() == 4){
            $form -> reportFormDirector($contextApplication[0]->getId(), $user->getSchoolObject()->getCct(), $_POST['type']);
          }else{
            $form -> reportForm($contextApplication[0]->getId(), $_POST['type']);
          }
					?>
					<br />
        ...
        <script src="../imports/js/factorClassroomValidate.js"></script>
