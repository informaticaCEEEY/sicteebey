...
<html lang="es">
	...
	<body>
		...
		<div class="container">
				...
				<form role="form" name="entry" id="entry" class="form-signin" action="factorZone.php" method="post" accept-charset="UTF-8">
					<?php
					$form -> contextZoneForm($contextYear, $_POST['type']);
    ...
    <script>var contextType = <?php echo($_POST['type']) ?></script>
		...
		<script src="../imports/js/factorSchoolZoneValidate.js"></script>
