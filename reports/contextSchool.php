...
<html lang="es">
	...
	<body>
		...
		<div class="container">
				...
				<form role="form" name="entry" id="entry" class="form-signin" action="factorSchoolInfo.php" method="post" accept-charset="UTF-8">
					<?php
					$form -> contextSchoolXForm($contextYear, '', $_POST['type']);
