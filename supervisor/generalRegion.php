...
<html lang="es">
	...
	<body>
		...
		$controller = new SupervisorSchoolRegionController();
		$supervisorSchoolRegion = $controller->getEntityByAction('user', $user->getId());
		...
		<div class="container">
			...
			echo('</form>');
			?>
			<form role="form" name="entry" id="entry" class="form-signin" action="../reports/reportRegion.php" method="post" accept-charset="UTF-8">
				<?php
				...
				$controller = new SupervisorSchoolRegionController();
				$supervisorSchoolRegion = $controller->getEntityByAction('user', $user->getId());
				$schoolRegion = $supervisorSchoolRegion[0]->getSchoolRegionZoneObject()->getSchoolRegion();
					
				$form -> reportRegionSupervisorForm($schoolRegion);
		...
		<script src="../imports/js/generalRegion.js"></script>
