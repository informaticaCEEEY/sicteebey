	...
	<body>
		...
		<div class="container">
			<div class="col-xs-12 text-center">
				...
				$schoolRegionZoneC = new SchoolRegionZoneController();
				$schoolRegionZone = $schoolRegionZoneC->getEntityAction($supervisorSchoolRegion[0]->getSchoolRegionZone());

				?>
				<div class="text-left">
					<div><h4 class='form-signin-heading'>Regi&oacute;n: <?php echo($schoolRegionZone->getSchoolRegionObject()->getName()); ?> </h4></div>
					<div><h4 class='form-signin-heading'>Nivel: <?php echo($schoolRegionZone->getSchoolLevelObject()->getName()); ?> </h4></div>
					<div><h4 class='form-signin-heading'>Modalidad: <?php echo($schoolRegionZone->getSchoolModeObject()->getName()); ?> </h4></div>
					<div><h4 class='form-signin-heading'>Zona: <?php echo(str_pad($schoolRegionZone->getZone(),  3, "0", STR_PAD_LEFT)); ?> </h4></div>
				</div>
				
				<form role="form" name="context16" id="context16" action="indexContext.php" method="post" accept-charset="UTF-8">
				...
				<div class="text-justify" id="instructions">
					<ul class="custom-bullet">
						<li>En el menu <a href="adminSchools.php">Escuelas</a> se podran consultar la lista de escuelas de su zona escolar:</li>
