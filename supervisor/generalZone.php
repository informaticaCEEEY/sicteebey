...
<html lang="es">
	...
	<body>
		...
		<div class="container">
				...
				echo('</form>');
				?>
				<form role="form" name="entry" id="entry" class="form-signin" action="dispatchers/schoolZoneDispatcher.php" method="post" accept-charset="UTF-8">
					<?php
					...
					$form -> reportZoneSupervisorForm($schoolLevel, $supervisorSchoolRegion[0]->getSchoolMode(), $supervisorSchoolRegion[0]->getSchoolZone());
					?>
					<br />
