...
<html lang="es">
	...
	<body>
		...
		<div class="container">
				...
				echo('</form>');
				?>
				<form role="form" name="entry" id="entry" class="form-signin" action="report_Construir_Tabla.php" method="post" accept-charset="UTF-8">
				<!--form role="form" name="entry" id="entry" class="form-signin" action="reporte2.php" method="post" accept-charset="UTF-8"-->
					<?php
