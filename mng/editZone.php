...
$schoolRegionZone = $schoolRegionZoneController->getEntityAction($idZone);
...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<form name="valid" id="valid" action="adminRegionZone.php" method="post"></form>
			<form role="form" name="entry" id="entry" class="form-signin" action="dispatchers/schoolRegionZoneDispatcher.php" method="post" accept-charset="UTF-8">
				<?php

					$form = new SchoolRegionZoneForm();
					$form -> editForm($schoolRegionZone);
		...
		<script src="../imports/js/schoolZone.js"></script>
		<script>
