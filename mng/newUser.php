...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			...
			<form role="form" name="entry" id="entry" class="form-signin" action="dispatchers/usersDispatcher.php" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
				<?php
		...
		<script src="../imports/js/functionsSchool.js"></script>
		<script>
