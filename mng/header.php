...
if (!isset($_SESSION['user'])) {
  ...
  if($user->getType() != 1 && $user->getType() != 989){
  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <!-- <li>
            <a href="cdiClassification.php">Reporte por tipo de población</a>
          </li> -->
          <li>
            <a href="generalZone.php">Reporte por zona</a>
          </li>
          <li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li>
            <a href="idaepyReport.php">Generar Carteles</a>
          </li>
        </ul>
      </li>
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li>
            <a href="adminSchools.php">Escuelas</a>
          </li>
          <li>
            <a href="adminNews.php">Eventos</a>
          </li>
          <li>
    ...
    <?php }else{
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a id="userName" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $user -> getCompleteName(); ?>
