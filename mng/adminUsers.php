...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<div class='text-center'><h2 class='form-signin-heading'>Usuarios</h2></div><hr />
			<?php
    	...
    	var linkAdd="newUser.php";
    	var linkEdit="editUserData.php?id=";
    	var linkPassword="editPassword.php?id=";
    	var linkDelete="../imports";
		var sourceLink="../imports/php/auxiliarFunctions/usersList.php";
        </script>
        <script type="text/javascript" src="../imports/js/configureUsersTable.js"></script>
        <script>
