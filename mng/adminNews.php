...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<div class='text-center'><h2 class='form-signin-heading'>Noticias</h2></div><hr />
			<?php
		  ...
		  <div class="modal-dialog modal-sm" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title text-center" id="myModalLabel">Aviso</h4>
		      </div>
		      <div class="modal-body text-center" id="tesd">
		        <h4>Seleccione una noticia</h4>
		      </div>
		    </div>
		  </div>
		</div>
    	...
    	var linkAdd="newNews.php";    	
    	var linkEdit="editNews.php?id=";
    	var linkView="news.php?id=";
    	var linkDelete="";
		var sourceLink="../imports/php/auxiliarFunctions/newsList.php";
        </script>        
        <script type="text/javascript" src="../imports/js/configureNewsTable.js"></script>
        <script>
