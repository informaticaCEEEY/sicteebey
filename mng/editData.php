...
$school = $schoolController->getEntityAction($idScho0l);
...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<form name="valid" id="valid" action="adminSchools.php" method="post"></form>
			<form role="form" name="entry" id="entry" class="form-signin" action="dispatchers/schoolDispatcher.php" method="post" accept-charset="UTF-8">
				<?php

					$form = new SchoolForm();
					$form -> editDataForm($school);
		...
		<script src="../imports/js/generalZone.js"></script>
		<script src="../imports/js/editSchoolData.js"></script>
		<script>
