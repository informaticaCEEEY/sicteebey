...
if(!$schoolRegionZone){
    ...
    header('location:contextZoneDirector.php');
    exit;
}
...
<html lang="es">
	...
	<body>
		...
		<div class="container-fluid">
				...
				echo('</form>');                
                include_once('../functions/functionChartIndexZone.php');
				$titleChart = "'Media por \u00EDndice'";

				?>
			<form name="schoolFactor" id="schoolFactor" action="contextZoneDirector.php" method="post" accept-charset="UTF-8"></form>
			...
			<form role="form" name="entry" id="entry" class="form-signin" action="dispatchers/indexListDispatcher.php" method="post" accept-charset="UTF-8">
				<?php
				$form -> contextSchoolZoneForm($schoolRegionZone->getId());
