...
$join = 'INNER JOIN economic_capital_context on economic_capital_context.student = e.student
         INNER JOIN school ON school.cct = economic_capital_context.cct
         INNER JOIN school_region_zone ON school_region_zone.id = school.school_region_zone';
$where = 'school_region_zone.zone = :schoolZone AND school_region_zone.level = 2 AND economic_capital_context.answered = :answered 
          AND e.year = 2015';
