...
$whereQuestion = "e.question = :question AND school_region_zone.zone = :schoolZone AND school_region_zone.level = 2 ";
$join = 'INNER JOIN school ON school.cct = e.cct
         INNER JOIN school_region_zone ON school_region_zone.id = school.school_region_zone';
...
foreach($questionsList as $question){
    ...
    $whereFieldsQuestion = array('question' => $question->getId(), 'schoolZone' => $schoolZoneObject->getZone());
    $whereFieldsAnswer = array('question' => $question->getId());
    $questionsContextList = $questionsContextController->displayByAction($whereQuestion, $whereFieldsQuestion, $join);
