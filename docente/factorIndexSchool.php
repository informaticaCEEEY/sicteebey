 ...
 ?>
		...
		<div class="container-fluid">
		    <?php if($factor == 17 || $factor == 30){ ?>
    			<form name="schoolIndex" id="schoolIndex" action="schoolIndexChart.php" method="post" accept-charset="UTF-8">
    			    <input type="hidden" id="cct" name="cct" value="<?php echo($school -> getCct()); ?>"/>
    			</form>
			<?php }else{ ?>
			    <form name="schoolIndex" id="schoolIndex" action="factorSchoolDirector.php" method="post" accept-charset="UTF-8">
