...
$where = 'e.modality = :modality AND e.level = :schoolLevel AND school_region = :schoolRegion AND zone = :zone AND
  factor != :factor AND factor < 12';
$whereFields = array('zone' => $schoolRegionZone->getZone(), 'factor' => 5,
  'schoolLevel' => $schoolRegionZone->getLevel(),
  'schoolRegion' => $schoolRegionZone->getSchoolRegion(),
  'modality' => $schoolRegionZone->getMode());
$dataReportGeneral = $factorZoneController->chartZone($where, $whereFields);
...
$where = 'school.school_region_zone = :school_zone';
$whereFields = array('school_zone' => $schoolRegionZone->getId());
