		...
		<div class="table-responsive col-xs-12 col-md-12">
			<table class="table table-bordered table-striped table-hover table-condensed">
				...
				<tbody>
					...
					// if($schoolRegionZone->getMode() == 5){
					//     if($cohorte->getId() < 12){
					//         $schoolList = $schoolController->getEntityByAction('school_region_zone', $schoolZone);
					//     }else{
					//         $schoolList = $schoolController->getEntityByAction('school_region_zone', $schoolZone);
					//     }
					// }else{
					...
					// $whereFields = array('grade' => 1, 'reprobate' => 0);
					// $numSchool = 1;
					...
					// 		$where2 .= ' cohorte.cct LIKE :cct'.$numSchool;
					// 	}else{
					// 		$where .= ' cohorte.cct LIKE :cct'.$numSchool.' OR  ';
					// 		$where1 .= ' e.cct LIKE :cct'.$numSchool.' OR  ';
					// 		$where2 .= ' cohorte.cct LIKE :cct'.$numSchool.' OR ';
					// 	}
