...
$join = 'INNER JOIN parent_support_context on parent_support_context.student = e.student
         INNER JOIN school ON school.cct = parent_support_context.cct
         INNER JOIN school_region_zone ON school_region_zone.id = school.school_region_zone';
$where = 'school_region_zone.zone = :schoolZone AND school_region_zone.level = 2 AND parent_support_context.answered = :answered 
          AND e.year = 2015';
