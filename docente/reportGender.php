...
<?php
        ...
        for ($ciclo = 1; $ciclo <= $numCiclo; $ciclo++) {                                                
            ...
            echo '<tr>
                    ...
                    <td>' . $modeContenT[1] . '</td>
                    <td>' . $totalCicloF[$ciclo][1] . '</td>
                    <td rowspan="' . $rowspan . '" class="theadR">' . $schoolPeriod[$ciclo-1]->getGrade() . '</td>';
            if($ciclo==1){
                echo '  <td class="success">' . $genderList1[$ciclo][1][1] . '</td>';
            }elseif($ciclo > 2){
                echo '  <td class="warning">' . $genderList1[$ciclo][1][1] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][1] . '</td>';
            }
            if($ciclo==2){
                echo '  <td class="success">' . $genderList1[$ciclo][1][2] . '</td>';
            }elseif($ciclo > 3){
                echo '  <td class="warning">' . $genderList1[$ciclo][1][2] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][2] . '</td>';
            }
            if($ciclo==3){
                echo '  <td class="success">' . $genderList1[$ciclo][1][3] . '</td>';
            }elseif($ciclo > 4){        
                echo '  <td class="warning">' . $genderList1[$ciclo][1][3] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][3] . '</td>';
            }
            if($ciclo==4){
                echo '  <td class="success">' . $genderList1[$ciclo][1][4] . '</td>';
            }elseif($ciclo > 5){
                echo '  <td class="warning">' . $genderList1[$ciclo][1][4] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][4] . '</td>';
            }
            if($ciclo==5){
                echo '  <td class="success">' . $genderList1[$ciclo][1][5] . '</td>';
            }elseif($ciclo > 6){
                echo '  <td class="warning">' . $genderList1[$ciclo][1][5] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][5] . '</td>';
            }
            if($ciclo==6){
                echo '  <td class="success">' . $genderList1[$ciclo][1][6] . '</td>';
            }elseif($ciclo > 7){
                echo '  <td class="warning">' . $genderList1[$ciclo][1][6] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][6] . '</td>';
            }
            if($ciclo==7){
                echo '  <td class="success">' . $genderList1[$ciclo][1][7] . '</td>';
            }elseif($ciclo > 8){
                echo '  <td class="warning">' . $genderList1[$ciclo][1][7] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][7] . '</td>';
            }
            if($ciclo==8){
                echo '  <td class="success">' . $genderList1[$ciclo][1][8] . '</td>';
            }elseif($ciclo > 9){
                echo '  <td class="warning">' . $genderList1[$ciclo][1][8] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][8] . '</td>';
            }
            if($ciclo==9){
                echo '  <td class="success">' . $genderList1[$ciclo][1][9] . '</td>';
            }elseif($ciclo > 10){
                echo '  <td class="warning">' . $genderList1[$ciclo][1][9] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][1][9] . '</td>';
            }
            echo '</tr>';
            echo '<tr>
                    <td>' . $modeContenT[2] . '</td>
                    <td>' . $totalCicloF[$ciclo][2] . '</td>';
            if($ciclo==1){
                echo '  <td class="success">' . $genderList1[$ciclo][2][1] . '</td>';
            }elseif($ciclo > 2){
                echo '  <td class="warning">' . $genderList1[$ciclo][2][1] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][1] . '</td>';
            }
            if($ciclo==2){
                echo '  <td class="success">' . $genderList1[$ciclo][2][2] . '</td>';
            }elseif($ciclo > 3){
                echo '  <td class="warning">' . $genderList1[$ciclo][2][2] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][2] . '</td>';
            }
            if($ciclo==3){
                echo '  <td class="success">' . $genderList1[$ciclo][2][3] . '</td>';
            }elseif($ciclo > 4){    
                echo '  <td class="warning">' . $genderList1[$ciclo][2][3] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][3] . '</td>';
            }
            if($ciclo==4){
                echo '  <td class="success">' . $genderList1[$ciclo][2][4] . '</td>';
            }elseif($ciclo > 5){
                echo '  <td class="warning">' . $genderList1[$ciclo][2][4] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][4] . '</td>';
            }
            if($ciclo==5){
                echo '  <td class="success">' . $genderList1[$ciclo][2][5] . '</td>';
            }elseif($ciclo > 6){
                echo '  <td class="warning">' . $genderList1[$ciclo][2][5] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][5] . '</td>';
            }
            if($ciclo==6){
                echo '  <td class="success">' . $genderList1[$ciclo][2][6] . '</td>';
            }elseif($ciclo > 7){
                echo '  <td class="warning">' . $genderList1[$ciclo][2][6] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][6] . '</td>';
            }
            if($ciclo==7){
                echo '  <td class="success">' . $genderList1[$ciclo][2][7] . '</td>';
            }elseif($ciclo > 8){
                echo '  <td class="warning">' . $genderList1[$ciclo][2][7] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][7] . '</td>';
            }
            if($ciclo==8){
                echo '  <td class="success">' . $genderList1[$ciclo][2][8] . '</td>';
            }elseif($ciclo > 9){
                echo '  <td class="warning">' . $genderList1[$ciclo][2][8] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][8] . '</td>';
            }
            if($ciclo==9){
                echo '  <td class="success">' . $genderList1[$ciclo][2][9] . '</td>';
            }elseif($ciclo > 10){
                echo '  <td class="warning">' . $genderList1[$ciclo][2][9] . '</td>';
            }else{
                echo '  <td>' . $genderList1[$ciclo][2][9] . '</td>';
            }
            echo '</tr>';
        }
        echo '</tbody>
    ...
    <?php
        ...
        for($cicloAct=1; $cicloAct<=$numCiclo; $cicloAct++){
            ...
            echo '<tr>                  
                    ...
                    <td rowspan="' . $rowspan . '" class="theadR">' . $nameCicloList[$cicloAct]. '</td>
                    <td>' . $modeContenT[1] . '</td>
                    <td>' . $genderList1[$cicloAct][1][$cicloAct] . '</td>
                    <td>' . $genderStatusList1[2*($cicloAct-1)]['statusA'] . '</td>
                    <td>' . $genderStatusList1[2*($cicloAct-1)]['statusR'] . '</td>
                    <td>' . $genderStatusList1[2*($cicloAct-1)]['statusX'] . '</td>
                    <td>' . $genderStatusList1[2*($cicloAct-1)]['statusZ'] . '</td>
            ...
            echo '<tr>
                    <td>' . $modeContenT[2] . '</td>
                    <td>' . $genderList1[$cicloAct][2][$cicloAct] . '</td>
                    <td>' . $genderStatusList1[2*($cicloAct-1)+1]['statusA'] . '</td>
                    <td>' . $genderStatusList1[2*($cicloAct-1)+1]['statusR'] . '</td>
                    <td>' . $genderStatusList1[2*($cicloAct-1)+1]['statusX'] . '</td>
                    <td>' . $genderStatusList1[2*($cicloAct-1)+1]['statusZ'] . '</td>
                    <td>' . $eficIntergrado . '%</td>
                    <td>' . $eficIntragrado . '%</td>
                    <td>' . $eficCohorte . '%</td>
                  </tr>';
...
<?php
            ...
            echo '
                <tr>                        
                    ...
                    <td>' . $modeContenT[1] . '</td>
                    <td>' . $totalCicloF[1][1] . '</td> 
                    <td rowspan="' . $rowspan . '" class="theadR">' . $nameCicloList[6] . '</td>
                    <td>' . $totalCicloF[6][1] . '</td>
                    <td>' . $genderList1[6][1][6] . '</td>
                    <td>' . $genderList1[6][1][5] . '</td>
                    <td>' . $rezagoGraList[6][1] . '</td>
                    <td>' . $noInsc . '</td>
                    <td>' . $noReg3Period . '</td>
                    <td>' . $genderStatusList1[10]['statusA'] . '</td>
                    <td>' . $genderList1[7][1][7] . '</td>
                </tr>';
                ...
                echo '<tr>
                        <td>' . $modeContenT[2] . '</td>
                        <td>' . $totalCicloF[1][2] . '</td>
                        <td>' . $totalCicloF[6][2] . '</td>
                        <td>' . $genderList1[6][2][6] . '</td>
                        <td>' . $genderList1[6][2][5] . '</td>
                        <td>' . $rezagoGraList[6][2] . '</td>
                        <td>' . $noInsc . '</td>
                        <td>' . $noReg3Period . '</td>
                        <td>' . $genderStatusList1[11]['statusA'] . '</td>
                        <td>' . $genderList1[7][2][7] . '</td>
                      </tr>';
...
<?php
        ...
        echo '
            <tr>                        
                ...
                <td>' . $totalCicloF[9][1] . '</td>
                <td>' . $genderList1[9][1][9] . '</td>
                <td>' . $genderList1[9][1][8] . '</td>
                <td>' . $rezagoGraList[9][1] . '</td>
                <td>' . $noInsc . '</td>
                <td>' . $noReg3Period . '</td>
                <td>' . $genderStatusList1[16]['statusA'] . '</td>
            </tr>';
        ...
        echo '
            <tr>
                <td>' . $modeContenT[2] . '</td>
                <td>' . $totalCicloF[1][2] . '</td>
                <td>' . $totalCicloF[9][2] . '</td>
                <td>' . $genderList1[9][2][9] . '</td>
                <td>' . $genderList1[9][2][8] . '</td>
                <td>' . $rezagoGraList[9][2] . '</td>
                <td>' . $noInsc . '</td>
                <td>' . $noReg3Period . '</td>
                <td>' . $genderStatusList1[17]['statusA'] . '</td>
            </tr>';
