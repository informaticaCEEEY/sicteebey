...
$join .= 'INNER JOIN idaepy_students on idaepy_students.student = parent_support_context.student ';
$where = 'parent_support_context.answered = :answered AND idaepy_students.cct = :cct AND idaepy_students.grade = :grade 
...
$whereFields = array('cct' => $school -> getCct(), 'grade' => $idaepyScheduled->getGrade(), 
    'schoolGroup' => $idaepyScheduled->getSchoolGroup(), 'year' => $year);
$parentSupportList = $parentSupportSchoolController -> displayByAction($where, $whereFields, $join);
