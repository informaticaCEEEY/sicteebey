...
$dataReportGeneral = $factorSchoolGroupController->chartClassroom($school->getCct(), $schoolGroup);
...
$where = 'e.cct LIKE :school AND idaepy_students.grade = :grade AND idaepy_students.school_group LIKE :schoolGroup ';
