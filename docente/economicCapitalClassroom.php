...
$join .= 'INNER JOIN idaepy_students on idaepy_students.student = economic_capital_context.student ';
$where = 'economic_capital_context.answered = :answered AND idaepy_students.cct = :cct AND idaepy_students.grade = :grade 
...
$whereFields = array('cct' => $school -> getCct(), 'grade' => $idaepyScheduled->getGrade(), 
    'schoolGroup' => $idaepyScheduled->getSchoolGroup(), 'year' => $year);
$economicCapitalList = $economicCapitalSchoolController -> displayByAction($where, $whereFields, $join);
