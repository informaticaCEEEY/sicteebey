...
(function(j, qa, p) {
	...
	n.oPagination = {
				...
				if (g.aanFeatures.p)
					for ( var m = g.aanFeatures.p, r = 0, s = m.length; r < s; r++)
						if (m[r].childNodes.length !== 0) {
							m[r].childNodes[0].className = g._iDisplayStart === 0 ? g.oClasses.sPagePrevDisabled
									: g.oClasses.sPagePrevEnabled;
							m[r].childNodes[1].className = g.fnDisplayEnd() == g
		...
		full_numbers : {
			...
			fnUpdate : function(g, m) {
				if (g.aanFeatures.p) {
					var r = n.oPagination.iFullNumbersShowPages, s = Math
					...
					for (r = s; r <= x; r++)
						F += y != r ? '<span class="' + v.sPageButton + '">'
								+ r + "</span>" : '<span class="'
					...
					for (s = x.length; r < s; r++)
						if (x[r].childNodes.length !== 0) {
							z = j("span:eq(2)", x[r]);
							z.html(F);
							j("span", z).click(U).bind("mousedown", C).bind(
									"selectstart", C);
	...
	j.fn.dataTable = function(g) {
		...
		function F(a, b) {
			...
			if (typeof a.aoPreSearchCols[b] == "undefined"
					|| a.aoPreSearchCols[b] === null)
				a.aoPreSearchCols[b] = {
					sSearch : "",
					bRegex : false,
					bSmart : true
		...
		function x(a, b, c) {
			...
			if (!a.oFeatures.bSort)
				b.bSortable = false;
			if (!b.bSortable || j.inArray("asc", b.asSorting) == -1
					&& j.inArray("desc", b.asSorting) == -1) {
				b.sSortingClass = a.oClasses.sSortableNone;
				b.sSortingClassJUI = ""
			} else if (j.inArray("asc", b.asSorting) != -1
					&& j.inArray("desc", b.asSorting) == -1) {
		...
		function v(a, b) {
			if (b.length != a.aoColumns.length && a.iDrawError != a.iDraw) {
				H(a, 0, "Added data (size " + b.length
						+ ") does not match known number of columns ("
						+ a.aoColumns.length + ")");
		...
		function z(a) {
			...
			i.length != h.length * a.aoColumns.length
					&& H(
							a,
							1,
			...
			if (a.nTHead.getElementsByTagName("th").length !== 0) {
				...
				for (d = a.aoColumns.length; b < d; b++) {
					...
					a.aoColumns[b].sClass !== null
							&& j(c).addClass(a.aoColumns[b].sClass);
					f = 1;
				...
				if (a.aiDisplay.length !== 0) {
					...
					for (i = i; i < h; i++) {
						...
						if (typeof a.fnRowCallback == "function") {
							l = a.fnRowCallback.call(a.oInstance, l,
									a.aoData[a.aiDisplay[i]]._aData, f, i);
							if (!l && !e) {
								H(a, 0,
					...
					e.innerHTML = typeof a.oLanguage.sEmptyTable != "undefined"
							&& a.fnRecordsTotal() === 0 ? a.oLanguage.sEmptyTable
							: a.oLanguage.sZeroRecords.replace("_MAX_", a
									.fnFormatNumber(a.fnRecordsTotal()));
					d[f].appendChild(e)
				}
				typeof a.fnHeaderCallback == "function"
						&& a.fnHeaderCallback.call(a.oInstance, j(">tr",
								a.nTHead)[0], V(a), a._iDisplayStart, a
								.fnDisplayEnd(), a.aiDisplay);
				typeof a.fnFooterCallback == "function"
						&& a.fnFooterCallback.call(a.oInstance, j(">tr",
								a.nTFoot)[0], V(a), a._iDisplayStart, a
								.fnDisplayEnd(), a.aiDisplay);
		...
		function ya(a) {
			...
			var b = p.createElement("div"), c = p.createElement("div"), d = p
					...
					.createElement("div"), i = p.createElement("div"), h = a.nTable
					.cloneNode(false), k = a.nTable.cloneNode(false), l = a.nTable
					.getElementsByTagName("thead")[0], q = a.nTable
					.getElementsByTagName("tfoot").length === 0 ? null
					: a.nTable.getElementsByTagName("tfoot")[0], t = typeof g.bJQueryUI != "undefined"
		...
		function Ba(a) {
			var b = a.nScrollHead.getElementsByTagName("div")[0], c = b
					.getElementsByTagName("table")[0], d = a.nTable.parentNode, f, e, i, h, k, l, q, t, G = [];
			...
			if (a.oScroll.sX === "") {
				...
				if (j.browser.msie && j.browser.version <= 7)
					a.nTable.style.width = u(j(a.nTable).outerWidth()
							- a.oScroll.iBarWidth)
			...
			if (a.oScroll.sY !== "" && a.oScroll.bCollapse) {
				...
				h = a.oScroll.sX !== "" && a.nTable.offsetWidth > d.offsetWidth ? a.oScroll.iBarWidth
						: 0;
		...
		function P(a, b, c) {
			...
			for (b = 0; b < a.aoPreSearchCols.length; b++)
				Da(a, a.aoPreSearchCols[b].sSearch, b,
		...
		function Da(a, b, c, d, f) {
			if (b !== "") {
				...
				for (d = a.aiDisplay.length - 1; d >= 0; d--) {
					f = ja(a.aoData[a.aiDisplay[d]]._aData[c],
							a.aoColumns[c].sType);
					if (!b.test(f)) {
		...
		function ha(a, b) {
			...
			for ( var c = 0, d = b.length; c < d; c++)
				a.asDataSearch[c] = ka(a, a.aoData[b[c]]._aData)
		}
		function ka(a, b) {
		...
		function O(a, b) {
			...
			if (!a.oFeatures.bServerSide
				...
				for (f = 0; f < k.length; f++) {
					...
					if (typeof n.afnSortData[h] != "undefined") {
		...
		function T(a) {
			...
			for (b = 0; b < i; b++)
				a.aoColumns[b].bSortable
						&& j(a.aoColumns[b].nTh).removeClass(
								h.sSortAsc + " " + h.sSortDesc + " "
					...
					for (b = 0; b < i; b++)
						if (d[b].className.indexOf(e + "1") != -1) {
							...
							for (a = d.length / i; c < a; c++)
								d[i * c + b].className = j
										.trim(d[i * c + b].className.replace(e
												+ "1", ""))
							...
							for (a = d.length / i; c < a; c++)
								d[i * c + b].className = j
										.trim(d[i * c + b].className.replace(
												" " + e + "3", ""))
						}
				h = 1;
				var k;
		...
		function Fa(a) {
			if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
				var b = a._iDisplayStart + 1, c = a.fnDisplayEnd(), d = a
						...
						.fnFormatNumber(b), i = a.fnFormatNumber(c), h = a
				...
				e = a.fnRecordsDisplay() === 0
						...
						: a.fnRecordsDisplay() === 0 ? a.oLanguage.sInfoEmpty
								+ " "
								+ a.oLanguage.sInfoFiltered.replace("_MAX_", h)
								+ a.oLanguage.sInfoPostFix
		...
		function va(a) {
			...
			j('select option[value="' + a._iDisplayLength + '"]', f).attr(
					"selected", true);
		...
		function $(a) {
			var b = 0, c, d = 0, f = a.aoColumns.length, e, i = j("th",
					a.nTHead);
			for (e = 0; e < f; e++)
				if (a.aoColumns[e].bVisible) {
					d++;
			...
			if (f == i.length && b === 0 && d == f && a.oScroll.sX === ""
					&& a.oScroll.sY === "")
		...
		function na(a) {
			if (!(!a.oFeatures.bStateSave || typeof a.bDestroying != "undefined")) {
				...
				f += "}";
				Ka(a.sCookiePrefix + a.sInstance, f, a.iCookieDuration,
		...
		function La(a, b) {
			if (a.oFeatures.bStateSave) {
				...
				if (d !== null && d !== "") {
					try {
						c = typeof j.parseJSON == "function" ? j.parseJSON(d
								.replace(/'/g, '"')) : eval("(" + d + ")")
					} catch (e) {
						return
					}
		...
		function Ka(a, b, c, d, f) {
			...
			var i;
			if (f !== null) {
				i = typeof j.parseJSON == "function" ? j.parseJSON(b)
						: eval("(" + b + ")");
		...
		function fa(a) {
			...
			for (i = a.length; d < i; d++) {
				...
				for (h = a[d].childNodes.length; f < h; f++)
					if (a[d].childNodes[f].nodeName.toUpperCase() == "TD"
							|| a[d].childNodes[f].nodeName.toUpperCase() == "TH")
						G.push(a[d].childNodes[f]);
				f = 0;
				for (h = G.length; f < h; f++) {
					var J = G[f].getAttribute("colspan") * 1, B = G[f]
							.getAttribute("rowspan") * 1;
					if (!J || J === 0 || J === 1) {
						k = l(b, d, t);
						b[d][k] = G[f].nodeName.toUpperCase() == "TD" ? 4
								: G[f];
						if (B || B === 0 || B === 1)
							for (e = 1; e < B; e++) {
								q(d + e);
				...
				if (b) {
					...
					if (b >= S(d)) {
						...
						if (i) {
							...
							for (e = l.length; f < e; f++)
								l[f]
										.appendChild(d.aoColumns[a].anTfExtra[f - 1])
						}
						f = 0;
						...
						for (e = l.length; f < e; f++) {
							q = j(l[f]).children();
							l[f].insertBefore(d.aoColumns[a].anThExtra[f - 1],
									q[k])
						}
						if (i) {
							i.insertBefore(h[a],
									i.getElementsByTagName("th")[k]);
							l = j(">tr", d.nTFoot);
							f = 1;
							for (e = l.length; f < e; f++) {
								q = j(l[f]).children();
								l[f].insertBefore(
										d.aoColumns[a].anTfExtra[f - 1], q[k])
							}
						}
						Z(d);
						f = 0;
						for (e = d.aoData.length; f < e; f++) {
							i = d.aoData[f]._anHidden[a];
							d.aoData[f].nTr.insertBefore(i, j(">td:eq(" + k
									+ ")", d.aoData[f].nTr)[0])
						}
					}
		...
		this.fnDestroy = function() {
			...
			j("tbody>tr>td." + a.oClasses.sRowEmpty, a.nTable).parent()
					.remove();
				...
				.each(function() {
					...
					if (this.nodeName.toLowerCase() != "table")
						...
						if (typeof g != "undefined" && g !== null) {
							...
							e.oFeatures.bServerSide && e.oFeatures.bSort
							...
							if (typeof g.oLanguage != "undefined")
								if (typeof g.oLanguage.sUrl != "undefined"
									...
									j.getJSON(e.oLanguage.sUrl, null, function(
											q) {
										y(e, q, true)
									});
									i = true
						...
						if (typeof g.aoColumnDefs != "undefined")
							for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
								...
								for (d = l.length; c < d; c++)
									...
									} else if (typeof l[c] == "number"
											&& l[c] < 0)
										x(e, e.aoColumns.length + l[c],
												g.aoColumnDefs[a]);
									else if (typeof l[c] == "string") {
										b = 0;
										for (f = e.aoColumns.length; b < f; b++)
											if (l[c] == "_all"
													|| e.aoColumns[b].nTh.className
															.indexOf(l[c]) != -1)
						...
						T(e);
						this.getElementsByTagName("thead").length === 0
								&& this.appendChild(p.createElement("thead"));
						this.getElementsByTagName("tbody").length === 0
								&& this.appendChild(p.createElement("tbody"));
