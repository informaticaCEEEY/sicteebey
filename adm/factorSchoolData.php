...
if(!isset($_POST['year']) || !isset($_POST['groupby']) || !isset($_POST['cct'])){
...
$contextApplication = $contextApplicationController->getEntityAction($year);
...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            include_once('../functions/functionChartSchoolData.php');

            ?>
            <form name="schoolFactor" id="schoolFactor" action="contextAdm.php" method="post" accept-charset="UTF-8">
            </form>
            <button class="buttonBack" type="button" onclick="document.forms.schoolFactor.submit()"><span>Regresar</span></button>

            <div class='text-center'>
                <h2 class='form-signin-heading'>Reporte por Aula</h2>
            </div>
            <br />
            ...
            <div class="col-xs-12 col-md-5">
                ...
                <div><h4 class='form-signin-heading'>Zona Escolar: <?php echo(str_pad($school->getSchoolRegionZoneObject()->getZone(),  3, "0", STR_PAD_LEFT)); ?> </h4></div>
            </div>
            <?php
            include_once('../functions/contextInfo.php');
            ?>
            <div class="col-xs-12 col-md-12">
                <hr />
                <div class='text-center'><h3 class='form-signin-heading'>Cuestionario de Contexto <?php echo $yearApplication; ?></h3></div>
            </div>
            <div class="row">
                ...
                <div id="reportGeneral" class="col-xs-12 col-md-12">
					<h3 class="text-center">Gráfica de la escuela</h3>
            ...
            <form role="form" name="entry" id="entry" class="form-signin" action="factorSchoolGroup.php" method="post" accept-charset="UTF-8">
                <?php
                ...
                $form = new FactorForm();
                $form -> contextFactorGroupForm($school->getCct(), $yearApplication, $groupby);
                ?>
                <br />
