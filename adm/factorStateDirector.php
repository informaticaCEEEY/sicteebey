...
if(!$indexList){
    ...
    header('location:contextDirector.php');       
}
?>
<!DOCTYPE html>
<html lang="es">
	...
	<body>
		...
		<div class="container-fluid">
                ...
                include_once('../functions/functionChartDirector.php');
                $titleChart = "'Media por factor'";
				
				?>
			<form role="form" name="schoolFactor" id="schoolFactor" action="contextDirector.php" method="post" accept-charset="UTF-8">            
            </form>
            <button class="buttonBack" type="button" onclick="document.forms.schoolFactor.submit()"><span>Regresar</span></button>
				
			<div class='text-center'>
				<h2 class='form-signin-heading'>Reporte por Estado</h2>
			</div>
			<br />				
			...
			<form role="form" name="entry" id="entry" class="form-signin" action="dispatchers/factorDispatcher.php" method="post" accept-charset="UTF-8">
				...
				$form -> contextFactorIndexDirectorForm($indexList->getId());
				?>
				<br />
