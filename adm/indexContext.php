...
<html lang="es">
	...
	<body>
        ...
        <!-- Yucatán -->
      <form role="form" name="context15" id="context15" action="../reports/context.php" method="post" accept-charset="UTF-8">
        <input type="hidden" id="year" name="year" value="2015"/>
        <input type="hidden" id="type" name="type" value="1"/>
        <input type="hidden" id="level" name="level" value="2"/>
      </form>
      <form role="form" name="context17" id="context17" action="../reports/context.php" method="post" accept-charset="UTF-8">
				...
				<div class="text-justify" id="instructions">
                    ...
                    ?>
                        <ul class="custom-bullet">
                            ...
                            <ul>
                                ...
                                <ul>
                                    <li>
                                        <a onclick="document.forms.context15.submit()" style="cursor:pointer;">Reporte General</a>
                                    </li>
                                </ul>
                                <!--ul>
                                    <li>
				    ...
				    <ul class="custom-bullet">
                            ...
                            <ul>
                                ...
                                <ul>
                                    <li>
                                        <a onclick="document.forms.context17.submit()" style="cursor:pointer;">Reporte General</a>
                                    </li>
                                </ul>
                                <!--ul>
                                    <li>
