...
$where = 'e.zone = :zone AND factor.year_application = :year AND e.school_region = :school_region AND
  e.level = :school_level AND e.modality = :modality AND factor.type = :type';
$whereFields = array('zone' => $schoolZone, 'year' => $_POST['year'],
  'school_region' => 18, 'school_level' => $schoolLevel,
  'modality' => $schoolMode, 'type' => $_POST['type']);
$join = 'INNER JOIN factor ON factor.id = e.factor';
...
if($_POST['year'] == '2015'){
    ...
    $where = 'school.zone = :school_zone AND school.mode = :modality AND
      school.level = :school_level';
    $whereFields = array('school_zone' => $schoolZone, 'school_level' => $schoolLevel,
    'modality' => $schoolMode);

    $teacherInteractionController = new TeacherInteractionController();
    $teacherInteractionList = $teacherInteractionController -> displayBy2Action($where, $whereFields, $join);
    ...
    foreach ($teacherInteractionList as $teacherInteraction) {
        switch($teacherInteraction['R8_R8']) {
            case 0 :
        ...
        switch($teacherInteraction['R9_R9']) {
            case 0 :
        ...
        switch($teacherInteraction['R10_R12']) {
            case 0 :
        ...
        switch($teacherInteraction['R11_R17']) {
            case 0 :
        ...
        switch($teacherInteraction['R12_R19']) {
            case 0 :
    ...
    $schoolEnvironmentList = $schoolEnvironmentController -> displayBy2Action($where, $whereFields, $join);
    ...
    foreach ($schoolEnvironmentList as $schoolEnvironment) {
        switch($schoolEnvironment['R3_R3']) {
            case 0 :
        ...
        switch($schoolEnvironment['R4_R4']) {
            case 0 :
        ...
        switch($schoolEnvironment['R5_R5']) {
            case 0 :
        ...
        switch($schoolEnvironment['R6_R6']) {
            case 0 :
        ...
        switch($schoolEnvironment['R7_R7']) {
            case 0 :
    ...
    $foodConsumptionList = $foodConsumptionController -> displayBy2Action($where, $whereFields, $join);
    ...
    foreach ($foodConsumptionList as $foodConsumption) {
        switch($foodConsumption['R17_R26']) {
            case 0 :
        ...
        switch($foodConsumption['R18_R27']) {
            case 0 :
        ...
        switch($foodConsumption['R19_R28']) {
            case 0 :
        ...
        switch($foodConsumption['R20_R29']) {
            case 0 :
        ...
        switch($foodConsumption['R21_R30']) {
            case 0 :
        ...
        switch($foodConsumption['R22_R31']) {
            case 0 :
        ...
        switch($foodConsumption['R23_R32']) {
            case 0 :
        ...
        switch($foodConsumption['R24_R33']) {
            case 0 :
    ...
    $drinksConsumptionList = $drinksConsumptionController -> displayBy2Action($where, $whereFields, $join);
    ...
    foreach ($drinksConsumptionList as $drinksConsumption) {
        switch($drinksConsumption['R25_R34']) {
            case 0 :
        ...
        switch($drinksConsumption['R26_R35']) {
            case 0 :
        ...
        switch($drinksConsumption['R27_R36']) {
            case 0 :
        ...
        switch($drinksConsumption['R28_R37']) {
            case 0 :
        ...
        switch($drinksConsumption['R29_R38']) {
            case 0 :
    ...
    $familyContextList = $familyContextController -> displayBy2Action($where, $whereFields, $join);
    ...
    foreach ($familyContextList as $familyContext) {
        ...
        if ($familyContext['R15_R24'] == 1) {
            switch($familyContext['R16_R25']) {
                case 0 :
    ...
    $affectiveEnvironmentList = $affectiveEnvironmentController -> displayBy2Action($where, $whereFields, $join);
    ...
    foreach ($affectiveEnvironmentList as $affectiveEnvironment) {
        switch($affectiveEnvironment['R43_R64']) {
            case 0 :
        ...
        switch($affectiveEnvironment['R44_R65']) {
            case 0 :
        ...
        switch($affectiveEnvironment['R45_R66']) {
            case 0 :
        ...
        switch($affectiveEnvironment['R46_R67']) {
            case 0 :
        ...
        switch($affectiveEnvironment['R47_R68']) {
            case 0 :
        ...
        switch($affectiveEnvironment['R48_R69']) {
            case 0 :
        ...
        switch($affectiveEnvironment['R49_R71']) {
            case 1 :
        ...
        switch($affectiveEnvironment['R50_R72']) {
            case 1 :
    ...
    $homeworkList = $homeworkController -> displayBy2Action($where, $whereFields, $join);
    ...
    $mayanLanguageList = $mayanLanguageController -> displayBy2Action($where, $whereFields, $join);
    ...
    $healthContextList = $healthContextController -> displayBy2Action($where, $whereFields, $join);
    ...
    foreach($healthContextList as $healthContext){
    	$healthContextArray[] = $healthContext['R40'];
    }
