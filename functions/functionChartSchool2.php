...
$teacherInteractionList = $teacherInteractionController -> displayByAction($where, $whereFields);
...
$schoolEnvironmentList = $schoolEnvironmentController -> displayByAction($where, $whereFields);
$schoolEnvironmentTotal = count($schoolEnvironmentTotal);
...
$foodConsumptionList = $foodConsumptionController -> displayByAction($where, $whereFields);
...
$drinksConsumptionList = $drinksConsumptionController -> displayByAction($where, $whereFields);
...
$familyContextList = $familyContextController -> displayByAction($where, $whereFields);
...
$affectiveEnvironmentList = $affectiveEnvironmentController -> displayByAction($where, $whereFields);
...
$homeworkList = $homeworkController -> displayByAction($where, $whereFields);
...
$mayanLanguageList = $mayanLanguageController -> displayByAction($where, $whereFields);
...
$whereFields = array('school' => $school->getCct(), 'year' => $year);
...
//ksort($healthContextArray);	
//arsort($healthContextArray);
