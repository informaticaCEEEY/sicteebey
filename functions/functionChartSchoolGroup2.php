...
$factorSchoolGroupController = new FactorClassroom2Controller();
$dataReportGeneral = $factorSchoolGroupController->chartClassroom($_POST['cct'], $schoolGroup);
...
$whereFields = array('school' => $_POST['cct'], 'grade' => $idaepyScheduled->getGrade(), 
